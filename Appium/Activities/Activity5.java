...
public class Activity5 {
    ...
    public void smsTest() {
        ...
        driver.findElement(AppiumBy.id("recipient_text_view")).sendKeys("1234567899");
        driver.pressKey(new KeyEvent(AndroidKey.ENTER));

        wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.id("compose_message_text")));
        driver.findElement(AppiumBy.id("compose_message_text")).sendKeys("Hey, how are you?");
        driver.findElement(AppiumBy.accessibilityId("Send SMS")).click();

        String messageTextSent = driver.findElement(AppiumBy.id("message_text")).getText();
        Assert.assertEquals(messageTextSent, "Hey, how are you?");
    }
